              ...
              <div className="grid lg:grid-cols-2 gap-6 mt-8">
                ...
                <Card className="border-primary/30">
                  ...
                  <CardContent className="space-y-2 text-sm text-muted-foreground">
                    ...
                    <p className="flex items-start gap-2"><CheckCircle2 className="h-4 w-4 mt-0.5 text-primary shrink-0" /><span>Independent verification: the MIT-licensed <a className="text-primary hover:underline" href="https://github.com/gabrielrondon/defarm-verify" target="_blank" rel="noopener noreferrer">defarm-verify</a> CLIs check anchors and signatures without touching DeFarm infrastructure.</span></p>
